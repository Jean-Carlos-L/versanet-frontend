   ...
   return (
      <div>
         <header className="bg-gray-100 w-11/12 p-3 rounded-md shadow-lg mb-5">
            <h1 className="text-3xl font-semibold text-gray-700">Detalles del rol</h1>
         </header>
               ...
               <div className="bg-gray-800 p-6 rounded-lg shadow-inner">
                  <div className="mb-6">
                     <p className="text-xl text-gray-300">
                        <span className="font-semibold text-indigo-400">Descripción: </span>
                        {role?.description || (
                  ...
                  <div className="mb-6">
                     <p className="text-xl text-gray-300">
                        ...
                        {role?.status === 1 ? (
                           <span className="inline-block px-3 py-1 rounded-full bg-green-500 text-green-100 font-medium">Activo</span>
                        ) : (
                           <span className="inline-block px-3 py-1 rounded-full bg-red-500 text-red-100 font-medium">Inactivo</span>
                        )}
                     </p>
                  </div>

                  <div>
                     <p className="text-xl font-semibold text-indigo-400 mb-3">Permisos:</p>
                     {role?.permissions.length > 0 ? (
                        ...
                        <p className="text-gray-500 italic">No tiene permisos asignados.</p>
                     )}
                  </div>
               </div>
            </div>
