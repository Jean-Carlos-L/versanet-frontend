...
import { ClipboardDocumentListIcon, IdentificationIcon, UserIcon } from "@heroicons/react/20/solid";
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 gap-6 p-6">
        <article className="p-6 border border-gray-200 rounded-lg shadow-md bg-white hover:shadow-lg transition duration-300">
          ...
          <div className="flex space-x-2">
            ...
            <Link
              ...
              className="px-4 py-2 text-sm font-semibold text-gray-800 border-gray-800 border rounded hover:bg-gray-800 hover:text-gray-50 transition"
            >
              Crear usuario
            </Link>
          </div>
        ...
        <article className="p-6 border border-gray-200 rounded-lg shadow-md bg-white hover:shadow-lg transition duration-300">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-bold text-gray-800">Planes</h2>
          </div>
          <p className="text-gray-600 mb-4">
            Administra los planes de la plataforma.
          </p>
          <div className="flex space-x-2">
            <Link
              to={ROUTES.PLANS}
        ...
        <article className="p-6 border border-gray-200 rounded-lg shadow-md bg-white hover:shadow-lg transition duration-300">
          ...
          <p className="text-gray-600 mb-4">
            Administra los registros de actividad de la plataforma.
          </p>
          <div className="flex space-x-2">
            <Link
              to={ROUTES.LOGS}
